  ...
  return (
    <div aria-hidden="true" className="relative h-full overflow-hidden">
      ...
      <div className="absolute left-1/2 h-full w-[26rem] -translate-x-1/2">
        ...
        />
        <Logo
          label="Stephane Plaza Immobilier"
          src="/logo-cluster/plaza_logo.svg"
          left={285}
          top={20}
        ...
        <Logo
          label="Urban Canopee"
          src="/logo-cluster/logo-urbancanopee.svg"
          left={255}
          top={210}
        ...
        <Logo
          label="Mira world"
          src="/logo-cluster/mira_logo.svg"
          left={144}
          top={40}
        ...
        <Logo
          label="Whitebay"
          src="/logo-cluster/whitebay-logo.svg"
          left={96}
          top={176}
